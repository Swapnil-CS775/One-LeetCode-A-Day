...
Difficulty: HardAccuracy: 65.14%Submissions: 11K+Points: 8
...
class kQueues {
    ...
    void enqueue(int x, int i) {
        ...
        if(front[i]==-1) front[i]=insertAt;
        else next[rear[i]] = insertAt;
    ...
    int dequeue(int i) {
        ...
        int removeAt=front[i];
        int ele=arr[removeAt];
        front[i]=next[removeAt];
        next[removeAt]=free;
        free=removeAt;
        return ele;
    }
